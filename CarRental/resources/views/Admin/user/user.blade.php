...
<h1>add new user</h1>
<div class="row">
	<form class="general_form" method="post" action="{{route('user.store')}}">
		{{csrf_field()}}
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
		            ...
		            <input type="text" name="start_time" class="form-control start_time" value="{{old('start_time')}}" >
		    </div>        
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
		            ...
		            <input type="text"  name="end_time" class="form-control end_time" value="{{old('end_time')}}" >
		    </div>        
		</div>
...
<script>
	$('.start_time , .end_time').hover(function(){
		$(this).attr('placeholder','Y-m-d h:m:s ');
	},function(){
